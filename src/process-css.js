...
function extractDecls(decls) {
  ...
  decls.forEach((rule) => {
    ...
    const isKuaracssSelector = isValidSelector(selectors);
    if (!isKuaracssSelector) return;
 ...
 * Only sort rules that are generated by kuaracss, which should have a selector
